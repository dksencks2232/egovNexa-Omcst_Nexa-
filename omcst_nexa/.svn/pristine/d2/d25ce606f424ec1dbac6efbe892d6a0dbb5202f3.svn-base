    ...
    return function()
    {
        ...
        ***********************************************************************************/
        ...
        this.fn_addTabBtn = function (tabID,tabName)
        {
         	...
         	var nGap = nexacro.Browser == "Runtime" ? 15 : 55;
         	var tabLength = 35;
            var objTextWidth =  "";

        	if (Eco.isEmpty(this.fn_findObj(tabID))) 
        	{
        	...
        	//var nCompWidth = this.fn_getWidth(tabObj,tabName)+15;	
        	var nCompWidth = this.fn_getWidth(tabObj,tabName)+nGap;
        ...
        this.fn_getWidth = function (obj,name)
        {
        	...
        	var objSize = nexacro.getTextSize(name, obj.currentstyle);
        ...
        this.fn_ArrangeWin = function(strType) 
        {
        	...
        	if (application.gds_openMenu.getRowCount() < 1) return;
        	...
        	switch(strType)
        	{
              ...
              for (i=1; i<iFramesCnt; i++)
        		//for (var i=iFramesCnt-1; i>1; i--) 
        		{			
        			Iject.$.workFrame.frames[i].set_showtitlebar(true);
        			Iject.$.workFrame.frames[i].style.set_border("1 solid #7f7f7bff");
