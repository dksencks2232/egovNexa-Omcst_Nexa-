(function()
{
    return function()
    {
        ...
        this.fileConfig = {		
        		...
        		host : "http://localhost:8080/nexaui/Service/",
        		uploadUrl : "extExcelFileUpload.jsp?path=import",
        ...
        this.displayTextFileNextStep = function()
        {
        	...
        	mainForm.div_step2.set_url("Excel::TextImportStep2.xfdl");
        ...
        this.displayNextStep = function(fileExtension)
        {
        	...
        	if(fileExtension == "xlsx")
        	{
        		mainForm.div_step2.set_url("Excel::ExcelImportStep2.xfdl");
        	}
