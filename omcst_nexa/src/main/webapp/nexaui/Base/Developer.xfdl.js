(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("Developer.xfdl", function() {
        ...
        this.loadIncludeScript("Developer.xfdl");
